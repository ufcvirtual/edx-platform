...
class YouTubeVideoTest(VideoBaseTest):
    ...
    def test_video_rendering_with_default_response_time(self):
        """
        Scenario: Video is rendered in Youtube mode if YouTube Server respond within default response time(1.5 seconds)
    ...
    def test_video_rendering_wo_default_response_time(self):
        """
        Scenario: Video is rendered in HTML5 if YouTube Server fails to respond within default response time(1.5 sec)
    ...
    def test_video_with_youtube_blocked(self):
        """
        Scenario: Video is rendered in HTML5 mode when YouTube API is blocked
        Given youtube server is up and response time is 2 seconds
        ...
        # for our video module the default response time to wait for YouTube is 1500 millisecond(1.5 seconds)
        # we wait 3 seconds so that video module completely switch to HTML5 mode
        time.sleep(3.0)
