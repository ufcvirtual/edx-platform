...
class HasEndedMayCertifyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.past_show_certs = get_dummy_course("2012-01-01T12:00", end=past_end, cert=True)
        self.past_noshow_certs = get_dummy_course("2012-01-01T12:00", end=past_end, cert=False)
        self.future_show_certs = get_dummy_course("2012-01-01T12:00", end=future_end, cert=True)
        self.future_noshow_certs = get_dummy_course("2012-01-01T12:00", end=future_end, cert=True)
