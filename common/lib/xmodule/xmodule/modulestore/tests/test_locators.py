...
class LocatorTest(TestCase):
    ...
    def test_course_constructor_bad_package_id(self):
        ...
        for bad_id in (' mit.eecs',
                       ...
                       'mit.eecs+foo+' + CourseLocator.BRANCH_PREFIX,
                       'mit.eecs+foo+' + CourseLocator.BRANCH_PREFIX + '+this+' + CourseLocator.BRANCH_PREFIX + '+that',
                       'mit.eecs+foo+' + CourseLocator.BRANCH_PREFIX + '+this+' + CourseLocator.BRANCH_PREFIX,
                       'mit.eecs+foo+' + CourseLocator.BRANCH_PREFIX + '+this ',
                       'mit.eecs+foo+' + CourseLocator.BRANCH_PREFIX + '+th%is ',
                       ):
            ...
            with self.assertRaises(InvalidKeyError):
                CourseKey.from_string('course-locator:' + bad_id)
    ...
    def test_course_constructor_url(self):
        ...
        testobj = CourseLocator.from_string("course-locator:{}+{}+{}+hw3".format(
    ...
    def test_course_constructor_url_package_id_and_version_guid(self):
        test_id_loc = '519665f6223ebd6980884f2b'
        testobj = CourseLocator.from_string(
